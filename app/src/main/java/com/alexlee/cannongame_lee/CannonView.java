...
public class CannonView extends SurfaceView
    ...
    // BLOCKER_SOUND_ID
    public static int BlOCKER_SOUND_ID;
    ...
    // plays a sound with the given soundId in the soundMap
    ...
    public void newGame() {
        ...
        blocker = new Blocker(this, Color.BLACK, MISS_PENALTY,
                ...
                (int) ((0.5 - BLOCKER_LENGTH_PERCENT * screenWidth)),
    ...
    public void drawGameElements(Canvas canvas) {
        ...
        // checks if the ball collides with the Blocker of any of the Targets and handles the collisions
        public void testForCollisions() {
            // remove any of the targets that the Cannonball collides with
            if (cannon.getCannonball() != null &&
                    cannon.getCannonball().isOnScreen()) {
                for (int n = 0; n < targets.size(); n++) {
                    if (cannon.getCannonball().collidesWith(targets.get(n))) {
                        ...
                        --n; // ensures we don't skip testing new target n
                        break;
                    }
                }
        ...
        // called when the user touches the screen this activity
        @Override
